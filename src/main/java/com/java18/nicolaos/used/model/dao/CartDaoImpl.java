...
public class CartDaoImpl implements CartDao{
	...
	private final String selectCartByMemberId ="FROM com.java18.nicolaos.used.model.UsedCart WHERE MEMBERID=:MEMBERID AND STATUS=TRUE";
	private final String selectCartById="FROM com.java18.nicolaos.used.model.UsedCart WHERE CARTID=:CARTID AND STATUS=TRUE";
