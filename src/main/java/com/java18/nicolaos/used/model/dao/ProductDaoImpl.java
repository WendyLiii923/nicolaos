...
public class ProductDaoImpl implements ProductDao {
	...
	private String selectProductById = "FROM com.java18.nicolaos.used.model.UsedProduct WHERE ID=:PRODUCTID";
	private String selectAllProduct = "FROM com.java18.nicolaos.used.model.UsedProduct";
	private String selectProductByParentId = "Select p From com.java18.nicolaos.used.model.UsedProduct p LEFT JOIN p.category c WHERE c.parentId = :categoryId";
	private String selectProductByQuery = "Select p FROM com.java18.nicolaos.used.model.UsedProduct p LEFT JOIN p.category c";
